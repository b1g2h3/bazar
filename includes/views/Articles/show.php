<div class="col-12 mt-5">
            ...
            <div class="modal-content">
                ...
                <form method="post" action="ajax.php"  data-form-output="form-output-global" data-form-type="forms">
                    <div class="modal-body createArticle">
                        ...
                        <?php
                        \App\Services\Input::create('Jméno', 'text', false);
                        ?>
    ...
    <div id="sendArticleOnEmail" class="modal fade d-print-none" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="ajax.php"  data-form-output="form-output-global" data-form-type="forms">
                    <div class="modal-body sendArticleOnEmail">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Zavřít</button>
                        <button type="button" class="btn btn-primary sendReservation">Odeslat inzerát</button>
                    </div>
                </form>
    ...
    <div class="row">
        ...
        <div class="d-flex col-12">
            <?php
            \Tracy\Debugger::barDump($article['images']);
